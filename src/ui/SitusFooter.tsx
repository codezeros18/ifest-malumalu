...
export default function SitusFooter({ bahasa }: SitusFooterProps) {
  ...
  return (
    <footer className="relative z-10 flex flex-col items-center gap-1 px-4 pb-6 pt-4 text-center text-[12px] text-[#8890a0] sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:text-left lg:px-14">
      <p>{t.footerKiri}</p>
      <p>{t.footerKanan}</p>
    </footer>
  );
